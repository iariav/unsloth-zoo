...
class UnslothVisionDataCollator:
    ...
    def __call__(self, examples):
        ...
        batch = self.processor(text=texts, images=None, videos=videos, return_tensors="pt",
                               padding=True)  # Encode texts and images into tensors
        ...
        if isinstance(self.processor, Qwen2VLProcessor):  # Check if the processor is Qwen2VLProcessor
            ...
            image_tokens = [
                self.processor.tokenizer.convert_tokens_to_ids(self.processor.image_token)]  # Convert image token to ID
